...
export default class Recipe {
  ...
  renderRecipe(r) {
    ele.recipe_area.innerHTML = `
        ...
        <div class="directions">
          ...
          <p>
            This recipe has been carefully
            <span>${
              r.publisher
            }</span> prepared and tested. You can access further
             details on their website.
          </p>

          <a href="${r.publisher_url}" target="_blank">Check</a>
        </div>
   `;
  ...
  isRecipeLiked() {
    ...
    // bulamazsa undefinded döndürecek!
